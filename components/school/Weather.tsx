    ...
    return (
        <div style={{ minWidth: 300 }}>
            ...
            <ContentCard style={{ padding: 20 }}>
                ...
                <Season name="Spring" high={weather.spring.high} low={weather.spring.low}/>
                <Season name="Summer" high={weather.summer.high} low={weather.summer.low}/>
                <Season name="Fall" high={weather.fall.high} low={weather.fall.low}/>
                <Season name="Winter" high={weather.winter.high} low={weather.winter.low}/>
