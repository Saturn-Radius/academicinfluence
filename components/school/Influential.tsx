    ...
    return (
        <ContentCard style={styles.cardWrapper}>
            <div style={{ flex: "1 1 100%", display: 'flex', justifyContent: 'flex-end' }}>
                <span style={{ paddingRight: 20, fontSize: 12 }}>Add to My Locker</span> <CheckBox />
            </div>

            <div style={{ width: "100%" }}>
                <img style={{ float: 'left', marginRight: 20, height: 60, width: 60 }} src="//placehold.it/60x60" />
            ...
            <div style={{ display: 'flex', width: "100%", justifyContent: 'space-between' }}>
                <div style={styles.influentialRow}>
                    <div>IR Score</div>
                    <div style={styles.influentialRowText}>{props.ir_score.toFixed(2) * 100}</div>
                </div>
            ...
            <div>
                <div style={{ color: PRIMARY_DARK, fontWeight: 'bold' }}>Influential Works</div>
                <div style={{ paddingBottom: 8 }}>Educated: A Memoir, The Body: A Guide for Occupants, Outliers: The Story of Success</div>
