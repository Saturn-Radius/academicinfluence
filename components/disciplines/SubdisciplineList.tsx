...
const SubdisciplineList = React.forwardRef(({ onClick, href, ...props }: any, ref) => {
        ...
        <div>
            ...
            <ul className="tableList">
              {props.disciplines
                ...
                .map((discipline: any)  => (
                    <li id={'list'+discipline.id} style={id==discipline.id ? styles.liStyle: styles.defaultliStyle} key={discipline.slug}>
                        <DisciplineLink discipline={discipline}>
                            <a style={id==discipline.id? styles.linkStyle: styles.defaultlinkStyle}>{discipline.name}</a>
                        </DisciplineLink>
                        <label className="container">
                            <input type="checkbox" onChange={ () => handleChecked(discipline.id) } checked={id===discipline.id} />
